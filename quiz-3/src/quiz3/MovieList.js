...
const Movies = () => {
    ...
    return (
        <>
            <h1 style={{ textAlign: "center", marginTop: '70px', marginBottom: '20px' }}>List Movie</h1>
            <table class="table table-striped" border="2px" style={{ width: '75%', marginLeft: 'auto', marginRight: 'auto' }}>
                <thead class="thead-dark">
                    <tr>
                        <th style={{ backgroundColor: "darkgray" }}> No </th>
                        <th style={{ backgroundColor: "darkgray" }}> Title </th>
                        <th style={{ backgroundColor: "darkgray" }}> Description </th>
                        <th style={{ backgroundColor: "darkgray" }}> Year </th>
                        <th style={{ backgroundColor: "darkgray" }}> Duration </th>
                        <th style={{ backgroundColor: "darkgray" }}> Genre </th>
                        <th style={{ backgroundColor: "darkgray" }}> Rating </th>
            ...
            <form onSubmit={handleSubmit} style={{ width: '75%', marginLeft: 'auto', marginRight: 'auto' }}>
                ...
                <button type="submit" class="btn btn-primary float-right" style={{ marginTop: "30px" }}> submit </button>
                {alert}
            </form>
        </>
    );
